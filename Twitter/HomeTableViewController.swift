...
//  Twitter
//
//  Created by Celeste Urena on 2/25/22.
...
class HomeTableViewController: UITableViewController {
    ...
    @objc func loadTweets() {
        ...
        TwitterAPICaller.client?.getDictionariesRequest(url: myUrl, parameters: myParams, success: { (tweets: [NSDictionary]) in // Retrieves dictionaries which are tweets
